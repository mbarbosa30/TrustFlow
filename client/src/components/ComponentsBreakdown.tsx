...
export function ComponentsBreakdown({ components, isLoading = false }: ComponentsBreakdownProps) {
  ...
  const componentData = [
    {
      name: "Flow",
      value: components.flow.toFixed(2),
      weight: "55%",
    ...
    {
      name: "Min-Cut",
      value: components.minCut.toString(),
      weight: "25%",
    ...
    {
      name: "Stability",
      value: components.stability.toFixed(2),
      weight: "10%",
    ...
    {
      name: "Depth",
      value: components.depth.toString(),
      weight: "10%",
    ...
    {
      name: "PageRank",
      value: components.pageRank.toFixed(3),
      weight: "0%",
      description: "Seed-personalized PageRank measuring network embeddedness. Higher = better connected to the trust graph. Currently experimental (0% weight).",
      ...
      <CardContent>
        ...
        <div className="mt-6 pt-4 border-t">
          <p className="text-xs text-muted-foreground">
            <strong>Note:</strong> PageRank is currently experimental and has 0% weight in your STS calculation. 
            It's shown here for transparency and future integration with transaction-weighted reputation.
          </p>
        </div>
      </CardContent>
    </Card>
