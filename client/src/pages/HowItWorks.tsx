            ...
            <div className="my-4 space-y-4">
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <ul className="text-sm text-muted-foreground mt-3 space-y-1 pl-4">
                  ...
                  <li><strong>11-15 vouches:</strong> Gentle decay (1.0 → 0.85)</li>
                  <li><strong>16-25 vouches:</strong> Steeper decay (0.85 → 0.55)</li>
                  <li><strong>25+ vouches:</strong> Asymptotic floor approaching 0.4</li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--score-growth) / 0.1)', border: '1px solid hsl(var(--score-growth) / 0.2)' }}>
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li><strong>Selectivity incentive:</strong> To maintain your min-cut score, vouch selectively for well-connected people</li>
                  <li><strong>Graph quality:</strong> When endorsements are selective, the resulting graph signals (flow, min-cut) are reliable</li>
